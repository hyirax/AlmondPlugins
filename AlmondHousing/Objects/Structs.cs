...
namespace AlmondHousing
{
    ...
    public struct CommonLandSet
    {
        ...
        public static CommonLandSet FromExd(HousingLandSet.LandSetStruct lset, int index)
        {
            ...
            // 【修复说明】：由于 7.0 API 更新移除了 MapRange 定义，且本插件未实际使用该字段，故直接赋 0 绕过报错
            ret.MapRange = 0; 
    ...
    public struct LayoutManager
    {
        ...
        public HousingController? HousingController
        {
            get
            {
                ...
                return global::AlmondHousing.HousingController.Get(_housingController);
            }
        }
        ...
        public IndoorAreaData? IndoorAreaData
        {
            get
            {
                ...
                return global::AlmondHousing.IndoorAreaData.Get(_indoorAreaData);
            }
        }
    }
